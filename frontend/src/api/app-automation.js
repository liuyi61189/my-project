...
/**
 * 登记 ADB 主机（手机所插电脑的 IP + 端口），登记后自动扫描该主机设备
 */
export function registerAdbHost(adb_host, adb_port = 5037) {
  return request({
    url: '/app-automation/devices/register_adb_host/',
    method: 'post',
    data: { adb_host, adb_port }
  })
}
