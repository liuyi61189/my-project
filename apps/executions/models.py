...
class TestPlan(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['creator'], name='idx_testplan_creator'),
            models.Index(fields=['is_active'], name='idx_testplan_is_active'),
        ]
...
class TestRun(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['project'], name='idx_testrun_project'),
            models.Index(fields=['status'], name='idx_testrun_status'),
            models.Index(fields=['assignee'], name='idx_testrun_assignee'),
        ]
...
class TestRunCase(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['testcase'], name='idx_testruncase_testcase'),
            models.Index(fields=['status'], name='idx_testruncase_status'),
        ]
