...
class ApiProject(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['owner'], name='idx_apiproj_owner'),
            models.Index(fields=['status'], name='idx_apiproj_status'),
        ]
...
class ApiCollection(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['project'], name='idx_apicoll_project'),
        ]
...
class ApiRequest(models.Model):
    ...
    class Meta:
        ...
        ordering = ['order', 'created_at']
        indexes = [
            models.Index(fields=['collection'], name='idx_apireq_collection'),
            models.Index(fields=['method'], name='idx_apireq_method'),
        ]
...
class RequestHistory(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['request'], name='idx_reqhist_request'),
            models.Index(fields=['executed_by'], name='idx_reqhist_executed_by'),
            models.Index(fields=['status_code'], name='idx_reqhist_status_code'),
            models.Index(fields=['-executed_at'], name='idx_reqhist_executed_at'),
        ]
...
class TestSuite(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['project'], name='idx_testsuite_project'),
        ]
...
class TestExecution(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['test_suite'], name='idx_testexec_test_suite'),
            models.Index(fields=['status'], name='idx_testexec_status'),
            models.Index(fields=['executed_by'], name='idx_testexec_executed_by'),
        ]
...
class ScheduledTask(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['status'], name='idx_schedtask_status'),
            models.Index(fields=['next_run_time'], name='idx_schedtask_next_run'),
            models.Index(fields=['created_by'], name='idx_schedtask_created_by'),
        ]
...
class TaskExecutionLog(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['task'], name='idx_tasklog_task'),
            models.Index(fields=['status'], name='idx_tasklog_status'),
        ]
